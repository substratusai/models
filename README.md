# :no_entry: THIS REPO IS DEPRECATED! Models now have [dedicated repositories starting with model](https://github.com/orgs/substratusai/repositories?q=model-&type=all&language=&sort=) :no_entry:
